...
public class App {
	...
	public static void main(String[] args) {
        ...
        Map<Character, Long> duplicatesV1 = Strings.countDuplicateCharsV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = Strings.countDuplicateCharsV2(TEXT);
        ...
        Map<String, Long> duplicatesV3 = Strings.countDuplicateCharsVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = Strings.countDuplicateCharsVCP2(TEXT_CP);
