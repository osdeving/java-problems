...
public class BinarySearchTree {
	...
	//
	// Nota: percorre a árvore como se fosse uma lista (curr = curr.next) mas decide se 'next' será right ou left
	...
	boolean searchNodeNonRecursive(Node root, int key) {
		...
		// root aqui é igual null
		// significa que root já chegou null ou percorreu para direita e esquerda sem nunca key==node.key 
		return false;
	}
